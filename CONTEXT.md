...
| **B-11** | 🟡 **Umbrales contrastados contra la Tabla 1 del Decreto 151/2022** (`NUTRICION.md §N6`). Cuatro coinciden ✅ y la ausencia de octógono de grasas trans **es correcta** ✅. Aparecieron **dos discrepancias**: al sodio le falta la condición alternativa `≥300 mg/100 g` (sub-marca), y el umbral de calorías de bebidas es **70 cuando la norma dice 25** — 70 no es ninguna de las dos etapas argentinas, es el valor chileno. **No se tocó el código**: la tabla viene de un PDF de editorial jurídica, no del BORA, y el `70` está respaldado por un test del equipo que codifica una observación de góndola. Lo resuelve la **calculadora oficial de ANMAT** en dos minutos | nutrition |
